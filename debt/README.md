...
- [pnpm updates stay on v11](2026-09-10-pnpm-update-lockfile.md): lifts when a stable newer release passes both targeted updates and clean frozen installs.
...
- [Forwarded client-IP header trusted by name, not proxy identity](2026-06-27-forwarded-header-trust-unbound.md): adopted from PR #511 review; the login/recovery limiter honours trusted_client_ip_header without a peer-CIDR binding; lifts when forwarded-IP trust is bound to an allow-listed reverse-proxy CIDR
