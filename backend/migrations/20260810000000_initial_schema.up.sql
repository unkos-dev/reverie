...
CREATE TABLE public.api_cache (
    ...
    CHECK ((
        (expires_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
        AND (expires_at < '10000-01-01 00:00:00+00'::timestamp with time zone)
    )),
    CONSTRAINT api_cache_fetched_at_ts_decode_range
    CHECK ((
        (fetched_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.authors (
    ...
    CHECK ((
        (created_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.field_locks (
    ...
    CHECK ((
        (locked_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.ingestion_jobs (
    ...
    CHECK ((
        (completed_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
    ...
    CHECK ((
        (started_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.instance_bootstrap (
    ...
    CHECK ((
        (bootstrapped_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.local_credentials (
    ...
    CHECK ((
        (updated_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.local_login_throttle (
    ...
    CHECK ((
        (locked_until >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.manifestation_external_ratings (
    ...
    CONSTRAINT manifestation_external_ratings_rating_range CHECK ((
...
CREATE TABLE public.manifestations (
    ...
    CHECK ((
        (enrichment_attempted_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.metadata_sources (
    ...
    CHECK ((
        (added_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.metadata_versions (
    ...
    CHECK ((
        (first_seen_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
    ...
    CHECK ((
        (last_seen_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
    ...
    CHECK ((
        (resolved_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.password_reset_pins (
    ...
    CHECK ((
        (consumed_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.reading_sessions (
    ...
    CHECK ((
        (ended_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.reading_state (
    ...
    CHECK ((
        (finished_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
        AND (finished_at < '10000-01-01 00:00:00+00'::timestamp with time zone)
    )),
    CONSTRAINT reading_state_last_read_at_ts_decode_range
    CHECK ((
        (last_read_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
    ...
    CONSTRAINT reading_state_progress_pct_range CHECK ((
...
CREATE TABLE public.settings (
    ...
    CONSTRAINT settings_enrichment_concurrency_check CHECK ((
    ...
    CONSTRAINT settings_writeback_concurrency_check CHECK ((
        (writeback_concurrency >= 1)
...
CREATE TABLE public.users (
    ...
    CHECK ((
        (disabled_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.webhook_deliveries (
    ...
    CHECK ((
        (delivered_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE public.webhook_event_dedupe (
    ...
    CHECK ((
        (seen_at >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE TABLE tower_sessions.session (
    ...
    CHECK ((
        (expiry_date >= '0001-01-01 00:00:00+00'::timestamp with time zone)
...
CREATE INDEX idx_device_tokens_user_active ON public.device_tokens USING btree (
    user_id,
    created_at DESC
...
CREATE INDEX idx_mv_pending_last_seen ON public.metadata_versions USING btree (
    manifestation_id,
    last_seen_at DESC
...
CREATE INDEX idx_reading_state_user_last_read ON public.reading_state USING btree (
    user_id,
...
CREATE INDEX idx_works_first_author_sort_desc ON public.works USING btree (
    first_author_sort_name DESC NULLS LAST,
    id DESC
);
...
CREATE POLICY manifestations_delete ON public.manifestations FOR DELETE TO reverie_app USING ((EXISTS (
    SELECT 1
    FROM public.users
    WHERE ((users.id = ((
        SELECT current_setting(
...
CREATE POLICY manifestations_update ON public.manifestations FOR UPDATE TO reverie_app USING ((EXISTS (
    SELECT 1
    FROM public.users
    WHERE ((users.id = ((
        SELECT current_setting(
