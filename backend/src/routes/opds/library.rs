...
#[utoipa::path(
    ...
    description = "Returns an OPDS navigation feed linking the New, Authors and Series subcatalogues for the caller's whole library. Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
    responses(
...
#[utoipa::path(
    ...
    description = "Returns an OPDS acquisition feed of the newest visible books, newest first, cursor-paginated via `cursor`. Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
    params(PageParams),
    responses(
...
#[utoipa::path(
    ...
    description = "Returns an OPDS navigation feed of authors with at least one visible book, cursor-paginated via `cursor`. Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
    params(PageParams),
    responses(
...
#[utoipa::path(
    ...
    description = "Returns an OPDS acquisition feed of one author's visible books, cursor-paginated via `cursor` (empty if the author is unknown). Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
...
#[utoipa::path(
    ...
    summary = "List series",
    description = "Returns an OPDS navigation feed of series with at least one visible book, cursor-paginated via `cursor`. Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
    params(PageParams),
    responses(
...
#[utoipa::path(
    ...
    description = "Returns an OPDS acquisition feed of one series' visible books, in series order (empty if the series is unknown). Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
...
#[utoipa::path(
    ...
    summary = "Search the OPDS catalogue",
    description = "Returns an OPDS acquisition feed of full-text search results over visible books, using the `q` query parameter; an empty or whitespace-only `q` yields an empty feed. Requires HTTP Basic authentication.",
    tag = "opds",
    security(("opds_basic" = [])),
    params(SearchParams),
    responses(
