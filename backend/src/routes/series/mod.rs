...
///
/// Merged into `crate::openapi::pilot_router` and
...
#[utoipa::path(
    ...
    description = "Returns the series identity plus its works in order, each with the manifestations visible to the caller.",
    tag = "series",
