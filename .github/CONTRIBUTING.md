...
Reverie targets **WCAG 2.2 Level AA** as a design invariant, and the target is recorded in [Web surfaces meet WCAG 2.2 Level AA](../docs/specs/accessibility/requirements/0004-web-surfaces-meet-wcag-2-2-level-aa.md). What the automated gate covers, what the manual audit owns, and the audit cadence are recorded in [Accessibility gate and manual audit](../docs/specs/accessibility/design/0002-accessibility-gate-and-manual-audit.md). The gate runs on the Playwright stack, a decision recorded in [Accessibility gate and render verification on Playwright](../docs/adr/0040-accessibility-gate-and-render-verification-on-playwright.md).
