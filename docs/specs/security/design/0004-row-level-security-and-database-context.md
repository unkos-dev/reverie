...
the Design "Database migration model" owns. It does not own the scope, role and ownership model that assigns ownership
to the data layer; that is the Design "Authorization axes", and this subject is the mechanism behind the ownership axis
