...
- [Connection pooling: in-process sqlx PgPool as the sole pooling layer](2026-06-08-connection-pooling-pgpool.md) (proposed, 2026-06-08)
- [Durable, crash-safe state in Postgres via atomic transactions](2026-06-08-postgres-backed-crash-safe-state.md) (proposed, 2026-06-08)
- [Scale stance: stateless application, operator-enabled HA, no first-party distributed infrastructure](2026-06-08-scale-stance-stateless-enable-not-own.md) (proposed, 2026-06-08)
- [Standards-first integrations: expose open interfaces, bundle no adjacent services](2026-06-08-standards-first-integrations.md) (proposed, 2026-06-08)
- [Durable job queue: Postgres-backed, SKIP-LOCKED, crash-only via restart-bounded reclaim](2026-06-08-durable-job-queue-crash-only.md) (proposed, 2026-06-08)
- [API versioning via URL path and OpenAPI 3.1 as the generated API contract](2026-06-08-api-versioning-openapi.md) (proposed, 2026-06-08)
- [No unbounded queries: keyset pagination as the default list contract](2026-06-08-keyset-pagination-list-contract.md) (proposed, 2026-06-08)
