...
expect "plan path rejected" 1 backend/src/lib.rs '// See plans/BLUEPRINT.md for the pipeline shape.'
expect "plan path in css rejected" 1 frontend/src/theme.css '/* Spec: plans/2026-06-18-editorial-design-system-tokens-design.md */'
expect "uppercase plan path rejected" 1 frontend/src/view.ts '// Plans/overview.md covers this.'
expect "plans word without path passes" 0 frontend/src/view.ts '// Future plans include caching here.'
expect "embedded plans substring passes" 0 backend/src/lib.rs '// The workplans/ directory is unrelated.'
